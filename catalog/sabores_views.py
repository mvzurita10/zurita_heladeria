...
def sabores_types_list_create(request):
    ...
    serializer = SaborTypeSerializer(data=request.data)
...
@permission_classes([IsAuthenticated])
def sabores_types_detail(request, id: str):
    _id = oid_or_none(id)
    if _id is None:
    ...
    if request.method in ["PUT", "PATCH"]:
        serializer = SaborTypeSerializer(data=request.data, partial=(request.method == "PATCH"))
        serializer.is_valid(raise_exception=True)
